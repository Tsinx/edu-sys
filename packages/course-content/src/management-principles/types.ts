...
export interface ManagementDiagram { kind:string; items:string[]; center?:string }
export type ManagementDemo = 'efficiency'|'system'|'timeline'|'theory-lenses'|'decision-process'|'payoff-matrix'|'environment-analysis'|'decision-tree';
