export interface RuntimeConfig { profile:"campus"|"development"; identity:string; avatar:"browser"|"lam"; simulation:string; synchronization:string; studentAiEnabled?:boolean; speech:{asr:boolean;tts:boolean;realtime?:{available:boolean}} }
